...
def swin_s(pretrained=False, **kwargs):
    model = SwinTransformer(img_size=224,embed_dim=96,depths=[ 2, 2, 18, 2 ],num_heads=[ 3, 6, 12, 24 ],window_size=7,drop_path_rate=0.2,)
    if pretrained:
        model_dict = model.state_dict()
        pretrained_dict = torch.load('./swin_pth/swin_small_patch4_window7_224_22k.pth')
